...
@Database(entities = [SessionEntity::class, MessageEntity::class, SummaryEntity::class, FactEntity::class, BranchNodeEntity::class, TaskFsmEntity::class], version = 10, exportSchema = false)
